...
# python apply_net.py dump configs/densepose_rcnn_R_101_FPN_DL_s1x.yaml output/model_0014999.pth /media/vrlab/新加卷/Dataset_AD/crossroad/img_east/img_test_east --output model_output/0014999.pkl -v
    ...
    def execute_on_outputs(
        ...
        if outputs.has("pred_boxes"):
            ...
            if outputs.has("pred_densepose"):
                ...
                # print(result["pred_densepose"].results)
                # for item in result['pred_densepose'].results:
                #     print(item[0])
