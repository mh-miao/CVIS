...
class DensePoseROIHeads(StandardROIHeads):
    ...
    def _forward_densepose(self, features, instances):
        ...
        if self.training:
            ...
            # import os
            # print(os.getpid(), proposals[0].proposal_boxes.tensor.shape)
            # print(os.getpid(), proposals[0].objectness_logits.shape)
            # print(os.getpid(), proposals[0].gt_classes.shape)
            # print(os.getpid(), proposals[0].gt_boxes.tensor.shape)
            
            proposals_dp = self.densepose_data_filter(proposals)
            # import os
            # print("111", os.getpid(), proposals_dp[0].proposal_boxes.tensor.shape)
            # print("111", os.getpid(), proposals_dp[0].objectness_logits.shape)
            # print("111", os.getpid(), proposals_dp[0].gt_classes.shape)
            # print("111", os.getpid(), proposals_dp[0].gt_boxes.tensor.shape)
            ...
            if len(proposals_dp) > 0:
                ...
                # print(features_dp.shape)

                densepose_head_outputs = self.densepose_head(features_dp)
                # print(densepose_head_outputs.shape)
    ...
    def forward(self, images, features, proposals, targets=None):
        ...
        if self.training:
            # print(instances[0])
            # print(instances[0].proposal_boxes.tensor.shape)
            # print(instances[0].objectness_logits.shape)
            # print(instances[0].gt_classes.shape)
            # print(instances[0].gt_boxes.tensor.shape)
